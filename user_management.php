...
?>
    ...
    <body>
      ...
      <!--Header-part-->
      <div id="header">
        <h1><a href="user_management.php">User Management</a></h1>
      </div>
      <!--close-Header-part-->
      ...
      <!--close-top-serch-->
      <!--sidebar-menu-->
      <div id="sidebar"><a href="user_management.php" class="visible-phone"><i class="icon icon-tasks"></i> <span>User Management</span></a>
        <ul>
      ...
      <div id="content">
        ...
        <div id="content-header">
          <div id="breadcrumb"> <a href="user_management.php" title="Go to here"><i class="icon icon-tasks"></i> User Management</a></div>
        </div>
        <!--End-breadcrumbs-->
        ...
        <div class="container-fluid">
          <div class="row-fluid">
            ...
            <div class="widget-box">
              <?php
              $query_data_wtr = "select * from tb_user where id_level = 1";
